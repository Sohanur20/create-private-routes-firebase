...
const Register = () => {
    ...
    return (
        ...
        <div className="w-full lg:mt-32   max-w-md p-8 space-y-3 rounded-xl border bg-slate-400   font-sans mx-auto">
            ...
            <form onSubmit={handleRegister} action="" className="space-y-6">
                ...
                <input className="btn-block btn bg-primary border-none text-white" type="submit" value="submit" />
