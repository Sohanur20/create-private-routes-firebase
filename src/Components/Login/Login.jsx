...
const Login = () => {
    ...
    return (
        <div className="w-full lg:mt-32  max-w-md p-8 space-y-3 rounded-xl border bg-green-300   font-sans mx-auto">
            ...
            <form onSubmit={handleLogin} action="" className="space-y-6">
                <div className="space-y-2 text-sm">
                    ...
                    <input type="text" name="email" id="email" placeholder="email" className="w-full px-4 py-3 rounded-md border border-indigo-300 focus:outline-none focus:ring  " />
                </div>
                <div className="space-y-2 text-sm">
